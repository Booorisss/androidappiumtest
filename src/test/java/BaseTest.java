...
public class BaseTest {
    ...
    {
        return driverWait.until(ExpectedConditions.attributeToBe(by,attribute,textToWait));
    }
    ...
    protected static MobileElement waitForVisible(MobileElement element) {
        return (MobileElement) driverWait.until(ExpectedConditions.visibilityOf(element));
    }
    ...
    public void setUp() throws IOException, InterruptedException {
      ...
      //  prop.load(file);
        ...
        capabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, "io.mattcarroll.androidtesting");
        ...
        capabilities.setCapability("autoGrantPermissions", "true"); //grant permission to system dialogues such as location
            capabilities.setCapability(MobileCapabilityType.APP, System.getProperty("user.dir") + "/app/app-debug-1.apk");
